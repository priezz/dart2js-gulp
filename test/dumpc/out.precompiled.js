...
function dart_precompiled($collectedClasses) {
  ...
  return [JS_CONST, Interceptor, JSBool, JSNull, JSArray, JSNumber, JSInt, JSDouble, JSString, TypeErrorImplementation, CastErrorImplementation, RuntimeType, RuntimeFunctionType, RuntimeTypePlain, RuntimeTypeGeneric, FunctionTypeInfoDecoderRing, ListIterator, bool, $double, Error, AssertionError, NullThrownError, ArgumentError, RangeError, UnsupportedError, StateError, ConcurrentModificationError, CyclicInitializationError, $int, List, Null, num, Object, String, StringBuffer];
}
